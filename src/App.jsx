...
function RouteErrorPage () {
  ...
  return (
    <div style={{
      ...
      fontFamily: FM, background: '#FDFAF7', padding: '24px',
      textAlign: 'center',
    }}>
      <div style={{
      ...
      <p style={{
        color: '#6B7280', fontSize: 15, maxWidth: 440,
      ...
      {message && (
        <details style={{
          maxWidth: 520, width: '100%', marginBottom: 28,
          background: '#F5F0EB', border: '1px solid #EDE7DE',
          borderRadius: 14, padding: '14px 18px', textAlign: 'left',
          cursor: 'pointer',
        }}>
          <summary style={{
            fontFamily: FM, fontSize: 12, color: '#9CA3AF',
            letterSpacing: '0.06em', userSelect: 'none'
          }}>
            Error details
          </summary>
          <p style={{
            fontFamily: FM, fontSize: 12, color: '#EF4444',
            margin: '12px 0 0', lineHeight: 1.7, wordBreak: 'break-word'
          }}>
            {message}
          </p>
        </details>
      ...
      <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', justifyContent: 'center' }}>
        <button onClick={() => window.location.reload()}
                style={{
                  background: SAF, color: '#fff', border: 'none', borderRadius: 999,
                  padding: '12px 28px', fontFamily: F, fontSize: 14, fontWeight: 700,
                  cursor: 'pointer', boxShadow: `0 6px 22px ${SAF}40`,
                }}>
          ↺ Reload Page
        </button>
        <button onClick={() => navigate('/')}
                style={{
                  background: '#fff', color: '#374151', border: '1.5px solid #EDE7DE',
                  borderRadius: 999, padding: '12px 28px', fontFamily: F,
...
function NotFoundPage () {
  return (
    <div style={{
      ...
      background: '#FDFAF7', gap: 16, padding: '24px'
    }}>
      <p style={{ fontFamily: FM, fontSize: 72, fontWeight: 900, color: '#111', lineHeight: 1, margin: 0 }}>404</p>
      <p style={{ fontSize: 17, color: '#6B7280', margin: 0 }}>This page doesn't exist.</p>
      <a href="/" style={{
        background: SAF, color: '#fff', borderRadius: 999,
        padding: '13px 32px', fontWeight: 700, fontSize: 14, textDecoration: 'none',
        boxShadow: `0 4px 18px ${SAF}35`, marginTop: 8
      }}>
        Back to Home
      </a>
    </div>
