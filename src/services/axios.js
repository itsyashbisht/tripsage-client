...
export const users = {
  ...
  removeSaved: (itineraryId) =>
    REQUEST.delete(buildUrl(API.USER.REMOVE_SAVED, { itineraryId })),
};
...
export const destinations = {
  ...
  getBySlug: (slug) =>
    REQUEST.get(buildUrl(API.DESTINATION.GET_BY_SLUG, { slug })),
  getHotels: (slug, params = {}) =>
    REQUEST.get(buildUrl(API.DESTINATION.GET_HOTELS, { slug }), { params }),
  getAttractions: (slug) =>
    REQUEST.get(buildUrl(API.DESTINATION.GET_ATTRACTIONS, { slug })),
  getRestaurants: (slug, params = {}) =>
    REQUEST.get(buildUrl(API.DESTINATION.GET_RESTAURANTS, { slug }), {
      params,
    }),
};
...
export const restaurants = {
  ...
  getById: (restaurantId) =>
    REQUEST.get(buildUrl(API.RESTAURANT.GET_BY_ID, { restaurantId })),
};
...
export const itineraries = {
  ...
  getByToken: (shareToken) =>
    REQUEST.get(buildUrl(API.ITINERARY.GET_BY_TOKEN, { shareToken })),
  getById: (itineraryId) =>
    REQUEST.get(buildUrl(API.ITINERARY.GET_BY_ID, { itineraryId })),
  delete: (itineraryId) =>
    REQUEST.delete(buildUrl(API.ITINERARY.DELETE, { itineraryId })),
  save: (itineraryId, note = "") =>
    REQUEST.post(buildUrl(API.ITINERARY.SAVE, { itineraryId }), { note }),
  unsave: (itineraryId) =>
    REQUEST.delete(buildUrl(API.ITINERARY.UNSAVE, { itineraryId })),
  share: (itineraryId, platform) =>
    REQUEST.post(buildUrl(API.ITINERARY.SHARE, { itineraryId }), { platform }),
};
...
export const reviews = {
  getAll: (destinationId) =>
    REQUEST.get(API.REVIEW.GET_ALL, { params: { destinationId } }),
  add: (data) => REQUEST.post(API.REVIEW.ADD, data),
  remove: (reviewId) =>
    REQUEST.delete(buildUrl(API.REVIEW.DELETE, { reviewId })),
};
