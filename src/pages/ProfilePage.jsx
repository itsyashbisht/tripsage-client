...
const AVATAR_PALETTES = [
  ['#FF6B35', '#F7931E'], ['#E8650A', '#FFB347'],
  ['#667EEA', '#764BA2'], ['#11998E', '#38EF7D'],
  ['#FC466B', '#3F5EFB'], ['#F7971E', '#FFD200'],
];
const avatarColors = (name) => AVATAR_PALETTES[(name?.charCodeAt(0) || 65) % AVATAR_PALETTES.length];
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        zIndex: 9999, width: 'max-content', maxWidth: 'calc(100vw - 32px)',
        display: 'flex', alignItems: 'center', gap: 14,
        background: isErr ? 'rgba(30,10,10,0.94)' : 'rgba(10,30,10,0.94)',
        borderRadius: 999, padding: '12px 20px 12px 14px',
  ...
  return (
    <motion.div variants={fadeUp(delay)}
                style={{
                  ...
                  borderRadius: 18, padding: '12px 18px', flexShrink: 0,
                }}>
      <div style={{
      ...
      <div>
        <p style={{
          margin: 0, fontFamily: FM, fontSize: 17, fontWeight: 700,
          color: '#fff', lineHeight: 1, letterSpacing: '-0.02em'
        }}>{value}</p>
        <p style={{
          margin: '3px 0 0', fontFamily: F, fontSize: 11,
...
function Field ({ label, children }) {
  return (
    <div>
      <p style={{
        fontFamily: FM, fontSize: 10, fontWeight: 700, color: '#9CA3AF',
        textTransform: 'uppercase', letterSpacing: '0.18em', margin: '0 0 8px',
      }}>{label}</p>
      {children}
    </div>
  );
...
function Input ({ type = 'text', value, onChange, icon: Icon, placeholder, disabled }) {
  ...
  return (
    <div style={{ position: 'relative' }}>
      {Icon && <Icon size={14} style={{
        ...
        color: '#BDB5AD', pointerEvents: 'none',
      }}/>}
      <input
        ...
        style={{
          ...
          border: '1.5px solid #EDE7DE', borderRadius: 14,
          fontFamily: F, fontSize: 14, color: disabled ? '#9CA3AF' : INK,
      ...
      {isPw && (
        <button type="button" onClick={() => setShow(p => !p)} style={{
          ...
          background: 'none', border: 'none', cursor: 'pointer', color: '#BDB5AD',
  ...
  return (
    <motion.div initial={{ opacity: 0, y: -4 }} animate={{ opacity: 1, y: 0 }}
                style={{
                  ...
                  background: '#FFF1F1', border: '1px solid #FED7D7',
                  borderRadius: 14, padding: '12px 16px',
                }}>
      <AlertCircle size={14} style={{ color: '#E53E3E', flexShrink: 0, marginTop: 1 }}/>
      <span style={{ fontFamily: F, fontSize: 13, color: '#C53030', lineHeight: 1.5 }}>{msg}</span>
    </motion.div>
  );
}
...
function StrengthBar ({ password }) {
  ...
  const score = password.length < 6 ? 1 : password.length < 10 ? 2 :
  ...
  return (
    <div>
      ...
      <p style={{ fontFamily: FM, fontSize: 11, color: colors[score], margin: 0 }}>
        {labels[score]}
      </p>
    </div>
  );
...
export default function ProfilePage () {
  ...
  // Auth guard
  useEffect(() => { if (!isAuth) navigate('/login', { replace: true }); }, [isAuth, navigate]);
  ...
  const TABS = [
    ...
    { id: 'security', label: 'Security', icon: Shield, hint: 'Password & safety' },
      ...
      <div style={{ fontFamily: F, background: '#FDFAF7', minHeight: '100vh' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '70vh' }}>
          <motion.div animate={{ opacity: [0.3, 1, 0.3] }} transition={{ duration: 1.8, repeat: Infinity }}
            ...
            <p style={{ fontFamily: FM, fontSize: 12, color: '#9CA3AF' }}>Loading…</p>
          </motion.div>
        </div>
      </div>
    );
  ...
  return (
    <div style={{ fontFamily: F, background: '#FDFAF7', minHeight: '100vh' }}>
      ...
      {/* ══ HERO ══════════════════════════════════════════════════════════════ */}
      <section ref={heroRef} style={{ position: 'relative', minHeight: 380, overflow: 'hidden' }}>
        ...
        <div style={{
          ...
          background: 'linear-gradient(to bottom, rgba(5,2,10,0.52) 0%, rgba(14,8,4,0.96) 100%)'
        }}/>
        <div style={{
          position: 'absolute', inset: 0, zIndex: 1,
          background: 'radial-gradient(ellipse at 15% 60%, rgba(232,101,10,0.20) 0%, transparent 60%)'
        }}/>
        <div style={{
          position: 'absolute', inset: 0, zIndex: 1,
          background: 'radial-gradient(ellipse at 85% 110%, rgba(232,101,10,0.28) 0%, transparent 50%)'
        }}/>
        ...
        <div style={{
          ...
          <motion.div variants={stagger} initial="hidden" animate="show">
            ...
            <div style={{ display: 'flex', alignItems: 'flex-end', gap: 24, flexWrap: 'wrap', marginBottom: 36 }}>
              
              {/* Avatar — large, glowing */}
              <motion.div variants={fadeUp(0)} style={{ flexShrink: 0 }}>
                <div style={{
                  width: 96, height: 96, borderRadius: 28, overflow: 'hidden',
                  background: avatar ? 'transparent' : `linear-gradient(145deg, ${c1} 0%, ${c2} 100%)`,
                  border: '2px solid rgba(255,255,255,0.16)',
                  boxShadow: `0 0 0 6px rgba(232,101,10,0.14), 0 20px 60px rgba(0,0,0,0.5)`,
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  fontSize: 38, fontWeight: 900, color: '#fff', position: 'relative',
                }}>
                  {avatar
              ...
              {/* Name block */}
              <motion.div variants={fadeUp(0.07)} style={{ flex: 1, minWidth: 0 }}>
                <p style={{
                  fontFamily: FM, fontSize: 11, color: SAF, letterSpacing: '0.22em',
                ...
                <div style={{ display: 'flex', gap: 14, flexWrap: 'wrap', alignItems: 'center' }}>
                  ...
                  {joinedAt && (
                    <span style={{
                      display: 'flex', alignItems: 'center', gap: 6,
                      fontFamily: FM, fontSize: 11, color: 'rgba(255,255,255,0.3)'
                    }}>
            ...
            <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
              <HeroPill delay={0.18}
                        ...
                        label="Saved Trips" value={saved.length}/>
              <HeroPill delay={0.24}
      ...
      <div className="pg-mobile-nav" style={{
        ...
        background: 'rgba(255,253,249,0.92)', backdropFilter: 'blur(16px)',
        ...
        {TABS.map(t => (
          <button key={t.id} onClick={() => setTab(t.id)} style={{
            ...
            <t.icon size={17} style={{ color: tab === t.id ? SAF : '#9CA3AF' }}/>
            <span style={{
              fontFamily: F, fontSize: 10, fontWeight: tab === t.id ? 700 : 500,
              ...
              {TABS.map((t, i) => (
                <button key={t.id} onClick={() => setTab(t.id)}
                        ...
                        style={{
                          ...
                          padding: '12px 14px', borderRadius: 16, marginBottom: i < TABS.length - 1 ? 4 : 0,
                          background: tab === t.id ? '#FDF0E6' : 'transparent',
                          border: 'none', cursor: 'pointer', textAlign: 'left',
                          transition: 'background 0.18s',
                        }}>
                  <div className="pg-tab-icon" style={{
                    width: 36, height: 36, borderRadius: 11, flexShrink: 0,
                    background: tab === t.id ? SAF : '#F5EFE8',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    transition: 'background 0.18s',
                  }}>
                    <t.icon size={15} style={{ color: tab === t.id ? '#fff' : '#9CA3AF' }}/>
                  </div>
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <p className="pg-tab-label" style={{
                      fontFamily: F, fontWeight: 700, fontSize: 13,
                      color: tab === t.id ? SAF : INK, margin: 0, transition: 'color 0.18s'
                    }}>
                      {t.label}
                    </p>
                    {t.hint && (
                      <p style={{ fontFamily: F, fontSize: 11, color: '#BDB5AD', margin: '2px 0 0' }}>{t.hint}</p>
                    )}
                  </div>
                  {t.badge > 0 && (
                    <span style={{
                      background: SAF, color: '#fff', borderRadius: 999,
                      fontSize: 11, fontWeight: 800, padding: '2px 9px', flexShrink: 0
                    }}>
                      {t.badge}
                    </span>
                  )}
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 18 }}>
              <div style={{
                ...
                {avatar ? <img src={avatar} alt=""
                               style={{ width: '100%', height: '100%', objectFit: 'cover' }}/> : initial}
              </div>
              <div style={{ minWidth: 0 }}>
                <p style={{
                  fontFamily: F, fontWeight: 800, fontSize: 14, color: '#fff',
                  margin: 0, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis'
                }}>
                  {user?.name || 'Traveller'}
                </p>
                <p style={{
                  fontFamily: FM, fontSize: 10, color: 'rgba(255,255,255,0.35)',
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              {[
                ...
                <div key={s.l} style={{
                  ...
                  borderRadius: 12, padding: '10px 6px', border: '1px solid rgba(255,255,255,0.06)'
                }}>
                  <p style={{ fontFamily: FM, fontSize: 15, fontWeight: 700, color: '#fff', margin: 0 }}>{s.v}</p>
                  <p style={{
                    fontFamily: F,
                    fontSize: 10,
            ...
            <motion.div key={tab}
                    ...
                    <Card>
                      ...
                      <div style={{
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                          <div style={{ width: 4, height: 22, borderRadius: 99, background: SAF }}/>
                          <div>
                            <h3 style={{
                              fontFamily: F, fontWeight: 800, fontSize: '0.95rem',
                              color: INK, margin: 0
                            }}>Personal Information</h3>
                            <p style={{ fontFamily: FM, fontSize: 11, color: '#BDB5AD', margin: '2px 0 0' }}>
                      ...
                      <form onSubmit={handleProfile}
                            style={{ padding: '24px 26px', display: 'flex', flexDirection: 'column', gap: 20 }}>
                        
                        {/* Avatar preview strip */}
                        <div style={{
                          display: 'flex', alignItems: 'center', gap: 16,
                          background: 'linear-gradient(135deg,#FDF0E6,#FFF8F2)',
                          ...
                          <div>
                            <p style={{ fontFamily: F, fontWeight: 700, fontSize: 14, color: INK, margin: '0 0 3px' }}>
                              {name || user?.name || 'Your Name'}
                            </p>
                            <p style={{ fontFamily: FM, fontSize: 11, color: '#9CA3AF', margin: 0 }}>
                              {avatar ? 'Custom avatar active' : 'Using initial avatar — add a URL below'}
                            </p>
                          </div>
                          {avatar && (
                            <button type="button" onClick={() => setAvatar('')}
                                    style={{
                                      marginLeft: 'auto', background: 'none', border: '1px solid #EDE7DE',
                                      borderRadius: 999, padding: '5px 12px', fontFamily: F, fontSize: 11,
                        ...
                        <div className="pg-2col">
                          ...
                          <Field label="Email Address">
                            <Input type="email" value={user?.email || ''} icon={Mail} disabled/>
                          </Field>
                        </div>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                          <motion.button type="submit" disabled={loading.updateDetails}
                                         whileHover={{ scale: 1.03, boxShadow: `0 10px 32px ${SAF}50` }}
                                         whileTap={{ scale: 0.97 }}
                                         style={{
                                           display: 'flex', alignItems: 'center', gap: 8,
                                           background: loading.updateDetails ? '#F5EDE4' : SAF,
                            ...
                            {loading.updateDetails ? '⟳ Saving…' : <><Edit3 size={14}/> Save Changes</>}
                          </motion.button>
                        </div>
                      </form>
                    </Card>
                  ...
                  <motion.div variants={fadeUp(0.1)}>
                    <div style={{
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 20 }}>
                        <div style={{ width: 4, height: 20, borderRadius: 99, background: SAF }}/>
                        <p style={{ fontFamily: F, fontWeight: 800, fontSize: '0.9rem', color: '#fff', margin: 0 }}>
                          Account Details
                        </p>
                      </div>
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
                        {[
                          { label: 'Status', val: user?.isVerified ? '✅ Verified' : '⏳ Pending', mono: false },
                          { label: 'Role', val: user?.role || 'user', mono: true },
                          { label: 'Member Since', val: joinedAt || '—', mono: true },
                          { label: 'User ID', val: (user?._id || '').slice(-10).toUpperCase(), mono: true },
                        ].map((row, i, arr) => (
                          <div key={row.label} style={{
                            ...
                            <span
                              style={{ fontFamily: F, fontSize: 13, color: 'rgba(255,255,255,0.4)' }}>{row.label}</span>
                            <span style={{
              ...
              {tab === 'security' && (
                <motion.div variants={stagger} initial="hidden" animate="show"
                  ...
                  <motion.div variants={fadeUp(0)}>
                    <Card>
                      <div style={{ padding: '22px 26px 18px', borderBottom: '1px solid rgba(232,101,10,0.08)' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                          <div style={{ width: 4, height: 22, borderRadius: 99, background: INK }}/>
                          <div>
                            <h3 style={{ fontFamily: F, fontWeight: 800, fontSize: '0.95rem', color: INK, margin: 0 }}>
                              Change Password
                            </h3>
                            <p style={{ fontFamily: FM, fontSize: 11, color: '#BDB5AD', margin: '2px 0 0' }}>
                      ...
                      <form onSubmit={handlePassword}
                        ...
                        <div style={{
                          height: 1,
                          background: 'linear-gradient(to right,transparent,#EDE7DE,transparent)',
                          margin: '0 -4px'
                        }}/>
                        ...
                        <Field label="Confirm New Password">
                          <Input type="password" value={confPw}
                                 ...
                                 icon={Lock} placeholder="Repeat new password"/>
                        </Field>
                        ...
                        {confPw && (
                          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }}
                                    style={{
                                      fontFamily: FM, fontSize: 12, margin: '-8px 0 0',
                        ...
                        <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                          <motion.button type="submit" disabled={loading.changePassword}
                                         whileHover={{ scale: 1.03, boxShadow: '0 10px 32px rgba(14,10,6,0.35)' }}
                                         whileTap={{ scale: 0.97 }}
                                         style={{
                                           display: 'flex', alignItems: 'center', gap: 8,
                                           background: loading.changePassword ? '#F3F4F6' : INK,
                                           color: loading.changePassword ? '#6B7280' : '#fff',
                                           border: 'none', borderRadius: 999, padding: '13px 30px',
                                           fontFamily: F, fontSize: 14, fontWeight: 700,
                            ...
                            {loading.changePassword ? '⟳ Updating…' : <><Shield size={14}/> Update Password</>}
                          </motion.button>
                        </div>
                      </form>
                    </Card>
                  ...
                  <motion.div variants={fadeUp(0.1)}>
                    <div style={{
                      ...
                      <p style={{
                        fontFamily: FM, fontSize: 11, color: SAF, letterSpacing: '0.18em',
                      ...
                      <div style={{ padding: '22px 26px 18px', borderBottom: '1px solid rgba(232,101,10,0.08)' }}>
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                            ...
                            <div>
                              <h3
                                style={{ fontFamily: F, fontWeight: 800, fontSize: '0.95rem', color: INK, margin: 0 }}>
                                Saved Trips
                              </h3>
                              <p style={{ fontFamily: FM, fontSize: 11, color: '#BDB5AD', margin: '2px 0 0' }}>
                                {saved.length > 0
                      ...
                      <div style={{ padding: '16px' }}>
                        ...
                        {!loading.savedPlans && saved.length === 0 && (
                          <div style={{ textAlign: 'center', padding: '52px 24px' }}>
                            ...
                            <p style={{ fontWeight: 800, fontSize: '1.1rem', color: INK, marginBottom: 8 }}>
                              No saved trips yet
                            </p>
                            <p style={{ color: '#9CA3AF', fontSize: 14, marginBottom: 30, lineHeight: 1.7 }}>
                              Plan a trip and tap <strong>Save Trip</strong> to find it here.
                            </p>
                            <Link to="/planner" style={{
                              display: 'inline-flex', alignItems: 'center', gap: 8,
                              background: SAF, color: '#fff', borderRadius: 999,
                              padding: '13px 30px', fontWeight: 700, fontSize: 14,
                              textDecoration: 'none',
                        ...
                        {!loading.savedPlans && saved.length > 0 && (
                          <motion.div variants={stagger} initial="hidden" animate="show"
                            ...
                            {saved.map(plan => {
                              ...
                              const tier = (itin.budgetTier || 'standard').toLowerCase();
                              
                              return (
                                <motion.div key={planId} variants={fadeUp(0)}
                                  ...
                                  <div style={{ flex: 1, minWidth: 0 }}>
                                    ...
                                    <div style={{ display: 'flex', gap: 7, flexWrap: 'wrap', alignItems: 'center' }}>
                                      {itin.totalDays && (
                                        <span style={{
                                          fontFamily: FM, fontSize: 11, color: '#9CA3AF',
                                          display: 'flex', alignItems: 'center', gap: 3
                                        }}>
                                          <Calendar size={10}/> {itin.totalDays}N
                                        </span>
                                      )}
                                      <span style={{
                                      ...
                                      {itin.destinationName && (
                                        <span style={{
                                          fontSize: 11, color: '#BDB5AD', fontFamily: F,
                                          display: 'flex', alignItems: 'center', gap: 3
                                        }}>
                                          <MapPin size={10}/>
                                  ...
                                  <div className="pg-plan-actions"
                                    ...
                                    {itin._id && (
                                      <Link to="/results" state={{ itinerary: itin }}
                                            style={{
                                              display: 'flex', alignItems: 'center', gap: 6,
                                              background: '#fff', border: '1.5px solid #EDE7DE',
                                    ...
                                    <motion.button
                                      onClick={() => dispatch(removeSavedPlan(itin._id))}
                                      ...
                                      style={{
                                        ...
                                        cursor: loading.removeSaved ? 'wait' : 'pointer',
                                        transition: 'background 0.18s',
                                      }}>
                  ...
                  {saved.length > 0 && (
                    <motion.div variants={fadeUp(0.1)}>
                      <Link to="/planner" style={{
                        ...
                        color: '#fff', borderRadius: 20, padding: '18px',
