    ...
    >
            ...
            <button
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow =
                  "0 12px 40px rgba(232,101,10,0.55)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = "scale(1)";
                e.currentTarget.style.boxShadow =
                  "0 8px 32px rgba(232,101,10,0.40)";
              }}
            >
      ...
      >
        ...
        <div style={{ gridColumn: "span 1" }}>
          ...
          >
            India's first AI-powered trip planner. We turn your travel dreams
            into detailed, day-by-day itineraries — in seconds, for free.
          </p>
            ...
            {SOCIAL.map(({ Icon, href, label }, i) => (
              <a
                ...
                style={{
                  ...
                  borderRadius: 10,
                  background:
                    hovered === `soc${i}` ? SAF : "rgba(255,255,255,0.06)",
                  border: `1px solid ${hovered === `soc${i}` ? SAF : "rgba(255,255,255,0.1)"}`,
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  color:
                    hovered === `soc${i}` ? "#fff" : "rgba(255,255,255,0.4)",
                  textDecoration: "none",
        ...
        <div>
          ...
          >
            Flash sales, seasonal guides and AI travel tips — straight to your
            inbox.
          </p>
          ...
          {subbed ? (
            ...
            >
              <p
                style={{ color: SAF, fontWeight: 700, fontSize: 14, margin: 0 }}
              >
                ✓ You're subscribed!
              </p>
              <p
